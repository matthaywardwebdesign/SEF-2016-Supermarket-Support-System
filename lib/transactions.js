...
module.exports.getTransactionByTransNo = function(getTransactionByTransNo, callback){
...
module.exports.getTransactionByCustNo = function(getTransactionByCustNo, callback){
   var conn = db.getConnection();
...
module.exports.getTransactionByDate = function(getTransactionByDate, callback){
   var conn = db.getConnection();
...
module.exports.getAllTransactions = function(getAllTransactions, callback){
   var conn = db.getConnection();
...
module.exports.saveTransaction = function(saveTransaction, callback){
   var conn = db.getConnection();
...
module.exports.deleteTransaction = function(deleteTransaction, callback){
   var conn = db.getConnection();
   r.table("transactions").get(this.transaction).delete().run(conn, function (err){
      if (err){
         callback(error.ERROR_DATABASE_ERROR);
            } else {
         callback(null);
